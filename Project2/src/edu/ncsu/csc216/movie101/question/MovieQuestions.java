...
/**
 * MovieQuestions maintains the questions and determines the order in which they 
 * are to be presented based on the user's answers.
 * 
 * @author Kaleb
 *
 */
public class MovieQuestions {
	...
	private List<Question> elemQuestions;
	...
	private List<Question> advQuestions;
	...
	/**
	 * AdvanceQuestionState maintains the advance questions and determines 
	 * if there needs to be a transitions based on the user's answers.
	 * 
	 * @author Kaleb
	 *
	 */
	...
	/**
	 * ElementaryQuestionState maintains the elementary questions and 
	 * determines if there needs to be a transitions based on the user's answers.
	 * 
	 * @author Kaleb
	 *
	 */
	public class ElementaryQuestionState extends QuestionState {
		...
		/**
		 * The constructor for ElementaryQuestoinState also sets the data
		 * members of attempts and numCorrectInRow to zero.
	...
	/**
	 * StandardQuestionState maintains the standard questions and determines 
	 * if there needs to be a transitions based on the user's answers.
	 * 
	 * @author Kaleb
	 *
	...
	public class StandardQuestionState extends QuestionState {
		...
		/**
		 * The constructor for StandardQuestoinState also sets the data
		 * member numCorrectInRow to zero.
